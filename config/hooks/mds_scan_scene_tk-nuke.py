...
# eng = sgtk.platform.current_engine().tank

# render_location_temp = eng.templates['maya_shot_render']
# publish_temp = eng.templates['maya_shot_rendered']
# maya_shot_work = eng.templates['maya_shot_work']
# maya_shot_publish= eng.templates['maya_shot_publish']
# for node in nuke.allNodes('Read'):
#     print node['name'].value()
#     fields = render_location_temp.get_fields(node['file'].value())
#     print fields
#     print publish_temp.apply_fields(fields)
#     print maya_shot_work.apply_fields(fields)
#     print maya_shot_publish.apply_fields(fields)
